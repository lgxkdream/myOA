...
/**
 * 权限数据初始化工具类（项目启动前执行，且仅执行一次）
 * 
 * @author LiGang
 * @date 2016-12-14 下午10:40:27
 * @version v1.0
 */
@Component
public class Installer {
	...
	public void install() {
		...
		menu1 = new Privilege("个人信息", "/person_editUserInfo", menu);
		...
		menu1 = new Privilege("公司网站", "http://www.cust.edu.cn/", menu);
