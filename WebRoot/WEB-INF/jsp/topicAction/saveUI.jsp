...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 主题设置
        </div>
...
<!--显示表单内容-->
<div id="MainArea">
<s:form action="topic_%{id == null ? 'add' : 'edit'}" cssStyle="margin: 0; padding: 0;">
	<div id="PageHead"></div>
	<center>
		...
		<div class="ItemBlockBorder">
			<table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
				...
				<tr height="240">
					...
					<s:textarea name="content" cssStyle="width:650px;height:200px"></s:textarea></td>
				</tr>
				<tr height="30">
