	...
	<center>
		<div class="ItemBlock_Title1" style="width: 98%">
			...
			<span style="margin-left:30px;">
			    <s:a action="topic_addUI?forum.id=%{#topic.forum.id}">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<td width="3" class="ForumPageTableTitleLeft">&nbsp;</td>
					...
					<td class="ForumPageTableTitle" align="right" style="padding-right:12px;">
					    <s:a cssClass="detail" action="reply_addUI?topic.id=%{#topic.id}"><img border="0" src="${pageContext.request.contextPath}/style/images/reply.gif" />回复</s:a>
					    <s:a action="topic_moveUI?id=%{#topic.id}"><img border="0" src="${pageContext.request.contextPath}/style/images/edit.gif" />移动到其他版块</s:a>
					    <s:a action="topic_changeType?id=%{#topic.id}&type=1" onclick="return confirm('要把本主题设为精华吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/forum_hot.gif" />精华</s:a>
					    <s:a action="topic_changeType?id=%{#topic.id}&type=2" onclick="return confirm('要把本主题设为置顶吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/forum_top.gif" />置顶</s:a>
					    <s:a action="topic_changeType?id=%{#topic.id}&type=0" onclick="return confirm('要把本主题设为普通吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/forum_comm.gif" />普通</s:a>
					</td>
					...
					<tr>
						<td rowspan="3" width="130" class="PhotoArea" align="center" valign="top">
							...
							<div class="AuthorPhoto">
								<img border="0" width="110" height="110" src="${pageContext.request.contextPath}/${topic.author.headimg}" 
						...
						<td align="center">
							<ul class="TopicFunc">
								...
								<li class="TopicFuncLi">
									<s:a cssClass="detail" action="topic_editUI?id=%{#topic.id}"><img border="0" src="${pageContext.request.contextPath}/style/images/edit.gif" />编辑</s:a>
									<s:a cssClass="detail" action="topic_delete?id=%{#topic.id}" onclick="return confirm('确定要删除本帖吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/delete.gif" />删除</s:a>
								</li>
								<!-- 文章表情与标题 -->
				...
				<table border="0" cellpadding="0" cellspacing="1" width="100%">
					<tr>
						<td rowspan="3" width="130" class="PhotoArea" align="center" valign="top">
							<!--作者头像-->
							<div class="AuthorPhoto">
								<img border="0" width="110" height="110" src="${pageContext.request.contextPath}/${author.headimg}" 
									onerror="this.onerror=null; this.src='${pageContext.request.contextPath}/style/images/defaultAvatar.gif';" />
							</div>
							<!--作者名称-->
						...
						<td align="center">
							<ul class="TopicFunc">
								<!--操作列表-->
								<li class="TopicFuncLi">
								    <s:a cssClass="detail" action="reply_editUI?id=%{id}"><img border="0" src="${pageContext.request.contextPath}/style/images/edit.gif" />编辑</s:a>
									<s:a cssClass="detail" action="reply_delete?id=%{id}&topic.id=%{topic.id}" onclick="return confirm('确定要删除本帖吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/delete.gif" />删除</s:a>
								</li>
								<!-- 文章表情与标题 -->
								<li class="TopicSubject">
			...
			<table border="0" cellspacing="1" width="98%" cellpadding="5" class="TableStyle">
				<tr height="30" class="Tint">
					...
					<td class="no_color_bg">
					    <s:textfield name="title" cssClass="InputStyle" cssStyle="width:90%" value="回复：%{#topic.title}"/>
