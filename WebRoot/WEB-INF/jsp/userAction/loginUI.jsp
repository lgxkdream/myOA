...
<s:form action="user_login" focusElement="loginNameInput">
    <div id="CenterAreaBg"> 
        <div id="CenterArea">
            ...
            <div id="LoginInfo">
                <table BORDER=0 CELLSPACING=0 CELLPADDING=0 width=100%>
                    <tr>
                        ...
                        <td>
                        	<s:textfield name="loginName" value="admin" size="20" tabindex="1" cssClass="TextField required" id="loginNameInput" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td><s:password name="password" value="admin" id="aa" size="20" tabindex="2" showPassword="false" cssClass="TextField required" /></td>
                    </tr>
                    <tr>
                		<td colspan="3"><!-- 显示错误 -->
            ...
            <div id="CopyRight"><a href="javascript:void(0)">&copy; 2016 版权所有 cust</a></div>
        </div>
    </div>
    </s:form>
</body>
