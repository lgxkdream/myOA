...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="processDefinition_deploy" enctype="multipart/form-data" method="post">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td><s:file name="resource" cssClass="InputStyle" cssStyle="width:450px;" accept=".zip" /> *</td>
                    </tr>
                </table>
            </div>
        </div>
