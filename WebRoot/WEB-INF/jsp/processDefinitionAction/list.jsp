...
<head>
    ...
    <script type="text/javascript">
	     function showProcessImage( deploymentId ){
            var url = "processDefinition_show.action?deploymentId=" + deploymentId; // + processDefId;
            myOpenWindow(url, 600, 500, "业务流程图", true);
            //window.open(url,300,200);
            //myShowModelessDialog(url, 600, 500, "showProcessImage", true);
        }
    </script> 
</head>
<body>
        ...
        <tbody id="TableData" class="dataContainer" datakey="processDefList">
           <s:iterator value="#processDefList">
			<tr class="TableDetail1 template">
					...
					<td>${description}&nbsp;</td>
					<td>
					    <s:a action="processDefinition_delete?key=%{key}" onclick="return confirm('确定要删除吗？')">删除</s:a>
            ...
            <table border="0" cellspacing="0" cellpadding="0" align="left">
                <tr>
			        <td><div class="FuncBtn">
                            ...
                            <div class=FuncBtnMemo><s:a action="processDefinition_deployUI">部署流程定义文档</s:a></div>
