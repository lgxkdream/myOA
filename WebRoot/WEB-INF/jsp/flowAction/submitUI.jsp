...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="flow_submit"  enctype="multipart/form-data" method="post">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <s:hidden name="documentTemplateId" />
                    <tr>
                        <td width="130">请选择填写好的文档</td>
                        <td><s:file name="resource" cssClass="InputStyle" cssStyle="width:450px;" /> *</td>
                    </tr>
                </table>
            </div>
        </div>
