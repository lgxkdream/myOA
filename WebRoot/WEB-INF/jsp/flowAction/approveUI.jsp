...
<div id=MainArea>
    <s:form action="flow_approve">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <s:hidden id="approval" name="approval" />
                    <tr>
                        <td>审批意见</td>
                        <td><s:textarea name="comment" cssClass="TextareaStyle" cssStyle="width: 500px;" /></td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div id="InputDetailBar" style="float:none">
			...
			<input type="image" id="agree" onclick="javascript:document.getElementById('approval').value='同意';" src="${pageContext.request.contextPath}/style/blue/images/button/agree.png"/>
			<input type="image" id="disagree" onclick="javascript:document.getElementById('approval').value='不同意';" src="${pageContext.request.contextPath}/style/blue/images/button/disagree.png"/>
