...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="documentTemplate_%{id ==null ? 'add' : 'edit' }" enctype="multipart/form-data" method="post">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr>
                        <td>所用流程</td>
                        <td>
                            <s:select list="#pdList" listKey="key" listValue="key" name="processKey"></s:select> *
						</td>
                    </tr>
                </table>
            </div>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
				   	<tr>
                        ...
                        <td>
                            <s:file name="resource" cssClass="InputStyle" cssStyle="width:450px;" />
                        </td>
                    </tr>
                </table>
            </div>
