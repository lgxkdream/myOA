...
<%@ page import="cn.cust.oa.util.OnlineListener"%>
<html>
<head>
    <title></title>
...
<div id="StatusBar">
    <div id="Online">
    	在线人员：共 <span class="OnlineUser" id="onlineUserNum"><%=OnlineListener.getOnlineCount()%></span> 人
    	<span class="OnlineView"><a href="javascript:void(0)">[查看在线名单]</a></span>
    </div>

    <div id="Info">
    	<a href="http://www.cust.edu.cn/" title = "长春理工大学首页" target=_blank >长春理工大学首页</a> |
        <a href="http://jwgl.cust.edu.cn/" title = "长春理工大学教务管理系统" target=_blank >长春理工大学教务管理系统</a>
    </div>
